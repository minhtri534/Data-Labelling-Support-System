...
export default function AuthLayout({ children, title, subtitle }: Props) {
  return (
    <div className="relative min-h-screen">
      <Background />
      <div className="relative z-10 mx-auto max-w-7xl grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8 px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="flex items-start xl:items-center justify-center px-0 sm:px-4">{children}</div>
      </div>
    </div>
  );
}
